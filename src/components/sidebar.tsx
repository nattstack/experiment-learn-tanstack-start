...
function SidebarLink(props: SidebarLinkProps) {
  ...
  return (
    <Link
      ...
      className="text-14 hover:bg-gray-3 rounded-8 data-[status=active]:bg-gray-4 data-[status=active]:text-gray-12 hover:text-gray-12 flex h-36 shrink-0 cursor-pointer items-center px-8 font-[450] transition-colors"
      to={to}
    >
