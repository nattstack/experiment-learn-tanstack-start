    ...
    return (
      <Column className="min-h-dvh [--dimension-sidebar-desktop-width-collapsed:52px] [--dimension-sidebar-desktop-width-expanded:240px] [--dimension-topbar-height:56px]">
        ...
        <Row className="grow">
          ...
          <Column
            as="main"
            className="bg-bg-primary border-border rounded-8 shadow-2 max-768:mr-0 max-768:mb-0 max-768:rounded-none max-768:shadow-none max-768:border-none mr-8 mb-8 grow border"
          >
            {/* Main wrapper */}
